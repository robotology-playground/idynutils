...
right_hand(walkman::robot::right_hand, moduleName, robotName, true, WALKMAN_CM_NONE),
    right_arm(walkman::robot::right_arm, moduleName, robotName, true, WALKMAN_CM_NONE),
    right_leg(walkman::robot::right_leg, moduleName, robotName, true, WALKMAN_CM_NONE),
    left_hand(walkman::robot::left_hand, moduleName, robotName, true, WALKMAN_CM_NONE),
    left_arm(walkman::robot::left_arm, moduleName, robotName, true, WALKMAN_CM_NONE),
    left_leg(walkman::robot::left_leg, moduleName, robotName, true, WALKMAN_CM_NONE),
    torso(walkman::robot::torso, moduleName, robotName, true, WALKMAN_CM_NONE),
